...
| # | 機能 | Issue | 状態 | 概要 |
|---|------|-------|------|------|
| 1 | AIチャットサポート（多言語対応） | [#1](https://github.com/nanashiNiA/travel-planner/issues/1) | 開発中 | 母国語で質問できるAIチャット |
| 2 | リアルタイム翻訳 | [#2](https://github.com/nanashiNiA/travel-planner/issues/2) | 計画中 | カメラ・テキスト・音声翻訳 |
...
| # | 機能 | Issue | 状態 | 概要 |
|---|------|-------|------|------|
| 5 | ホテル検索・予約管理 | [#5](https://github.com/nanashiNiA/travel-planner/issues/5) | 計画中 | ホテル検索・予約情報一元管理 |
